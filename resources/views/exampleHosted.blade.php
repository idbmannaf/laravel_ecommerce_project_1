...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8 order-md-1 m-auto">
            <h4 class="mb-3">Total Pay</h4>
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                <input type="hidden" value="{{ csrf_token() }}" name="_token" />
                <input type="hidden" name="final_total_payment" value="{{ session('subtotal') - session('discount') }}">
                {{-- <div class="row">
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (BDT)</span>
                        <strong>{{ session('subtotal')}} TK</strong>
                    </li>
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Disscount (BDT)</span>
                        <strong>{{ session('discount') }} TK</strong>
                    </li>
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Sub Total (BDT)</span>
                        <strong>{{ session('subtotal') - session('discount') }} TK</strong>
                    </li>
                </ul>
                <hr class="mb-4">
